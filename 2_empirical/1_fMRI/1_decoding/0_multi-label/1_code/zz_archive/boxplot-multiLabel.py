...
# READ THE DATA
# ============================================================================
df = pd.read_csv(os.path.join(data_path + 'clean_boxplot_multiLabel.csv'), sep=';')  # , index_col=0
...
ax.set_title('Multi-label classification using chunk-level CV\n', fontsize=30)

ax = sns.boxplot(x='roi', y='accuracy', hue='category', data=df,
                 palette=palette, linewidth=3.5)  # inner=None, color='.8'

...
project_path = '/Users/danalclop/Google Drive/1905-SOCIALCON/Figures/04Explained-Variance/'
...
# READ THE DATA
# ============================================================================
df = pd.read_csv(os.path.join(data_path + 'encoding-values-bestvar.csv'), sep=';')  # , index_col=0
...
ax = sns.boxplot(x='roi', y='accuracy', hue='category', data=df, palette=palette1)  # inner=None, color='.8'
ax = sns.stripplot(x='roi', y='accuracy', hue='category', data=df, palette=palette2,
                   jitter=True, linewidth=1, dodge=True, alpha=.65)
# ax.set(ylim=(0.2, 0.6))
ax.set_xticklabels(roi_order, rotation='45')
plt.savefig(os.path.join(des_path + 'encoding-boxplot.png'), dpi=300)
